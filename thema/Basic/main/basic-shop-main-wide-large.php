	...
	<div class="row">
		<div class="col-sm-8">
			...
			<div class="widget-box">
				<?php echo apms_widget('basic-shop-event-slider', $wid.'-wm1', 'caption=1 nav=1 item=3 lg=2 md=2 sm=2', 'auto=0'); ?>
			</div>
			<!-- 이벤트 끝 -->	
		</div>
		<div class="col-sm-4">
			...
			<div class="widget-box">
				<?php echo apms_widget('basic-post-list', $wid.'-wm2', 'icon={아이콘:bell} rows=6 date=1 strong=1,2'); ?>
			</div>
			<!-- 알림 끝 -->
		</div>
	</div>
