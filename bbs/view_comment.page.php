...
// APMS
$comment_login_url = './login.php?wr_id='.$wr_id.$qstr.'&amp;url='.urlencode(G5_BBS_URL.'/board.php?bo_table='.$bo_table.'&amp;wr_id='.$wr_id.$qstr);
$comment_url = './view_comment.page.php?bo_table='.$bo_table.'&amp;wr_id='.$wr_id.'&amp;crows='.$crows;
$comment_script_url = './view_comment.page.php?bo_table='.$bo_table.'&wr_id='.$wr_id.'&crows='.$crows;
$comment_action_url = './write_comment_update.page.php';
$comment_page = './view_comment.page.php?bo_table='.$bo_table.'&amp;wr_id='.$wr_id.'&amp;crows='.$crows.'&amp;page=';
