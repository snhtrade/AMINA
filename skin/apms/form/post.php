...
<section id="anc_sitfrm_ini" class="anc-section">
	...
	<div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            <td colspan="2"> 
				<?php echo editor_html('it_explan', $it['it_explan']); ?>
			</td>
		</tr>
		<tr>
		...
		<?php if($is_auth) { // 관리자일 때만 출력 ?>
			...
			<tr>
				...
				<td>
					...
					<input type="text" name="it_sell_email" value="<?php echo $it['it_sell_email']; ?>" id="it_sell_email" class="frm_input sm">
				</td>
			</tr>
			<tr>
	...
	<div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            <td colspan="2" class="iframe"> 
				<?php echo editor_html('pt_explan', get_text($it['pt_explan'], 0)); ?>
			</td>
        </tr>
		<tr>
		...
		<tr>
            <td colspan="2" class="iframe">
				<?php echo editor_html('pt_mobile_explan', get_text($it['pt_mobile_explan'], 0)); ?>
			</td>
		</tr>
...
<?php if($is_auth) { // 관리자일 때만 출력 ?>
	...
	<section id="anc_sitfrm_optional" class="anc-section">
		...
		<div class="tbl_frm01 tbl_wrap">
			...
			<tr>
				<td colspan="2" class="iframe"><?php echo editor_html('it_head_html', get_text($it['it_head_html'], 0)); ?></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" class="iframe"><?php echo editor_html('it_tail_html', get_text($it['it_tail_html'], 0)); ?></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" class="iframe"><?php echo editor_html('it_mobile_head_html', get_text($it['it_mobile_head_html'], 0)); ?></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" class="iframe"><?php echo editor_html('it_mobile_tail_html', get_text($it['it_mobile_tail_html'], 0)); ?></td>
			</tr>
			</tbody>
			</table>
		</div>
